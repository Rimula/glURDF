...
// camera
learnOpenGL::Camera camera(glm::vec3(10.5f, 10.0f, 18.0f));
...
int main(int argc, char** argv)
{
    ...
    // ---------------------------------------
    shared_ptr<Model_> scene(new Model_ ("scene", scene_file_path, "Red", 0, init, init, glm::vec3(1.0), glm::vec3(1.0), nullptr));
    glm::mat4 tmp = glm::rotate(init, glm::radians(90.0f), glm::vec3(-1.0f,0.0f,0.0f));  
    tmp = glm::rotate(tmp, glm::radians(90.0f), glm::vec3(0.0f,0.0f,-1.0f));  
